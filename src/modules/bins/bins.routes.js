...
router.post("/", auth, authorize(["admin", "gestionnaire"]), validate(createBinSchema), binsController.create);
router.patch("/:id", auth, authorize(["admin", "gestionnaire", "agent"]), validate(updateBinSchema), binsController.update);
